...
<body bgcolor='black'>
	<div class="topnav">
		<a href="index.jsp">Home</a> <a href="itemsDAO">Items</a> <a
			href="cartDAO">Cart</a> <a href="#wallet">Wallet</a> <a
			class="active" href="order_history.jsp">Order-History</a> <a
			class="myprofile" href="profileDAO">My Profile</a>
	</div>
	...
	<div>
		<table>
			<tr>
				<th
					style="text-shadow: 2px 2px 8px #FF0000; color: yellow; font-family: courier;">Date</th>
				<th
					style="text-shadow: 2px 2px 8px #FF0000; color: yellow; font-family: courier;">Time</th>
				<th
					style="text-shadow: 2px 2px 8px #FF0000; color: yellow; font-family: courier;">Order-ID</th>
				<th
					style="text-shadow: 2px 2px 8px #FF0000; color: yellow; font-family: courier;">Total
					Amount</th>
